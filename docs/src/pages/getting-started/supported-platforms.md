...
Material-Next supports the latest, stable releases of all major browsers and platforms.
...
Because Material-Next supports server side rendering, we need to support the latest, stable releases of [Node.js](https://github.com/nodejs/node).
