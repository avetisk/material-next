...
Have a look at the [Create React App with TypeScript](https://github.com/material-next/material-next/tree/v1-beta/examples/create-react-app-with-typescript) example.
