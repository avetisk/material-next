...
// https://github.com/@material-next/core/@material-next/core/releases/tag/v1.0.0-alpha.21
 ...
 * e.g. import { red, blue } from '@material-next/core/styles/colors'
 * @param {jscodeshift_api_object} j
 * @param {jscodeshift_ast_object} root
 ...
 * e.g. import * as colors from '@material-next/core/styles/colors'
 * @param {jscodeshift_api_object} j
 * @param {jscodeshift_ast_object} root
 * @param {string} importPath
 * @param {string} targetPath
...
module.exports = function transformer(file, api, options = {}) {
  ...
  const importPath = options.importPath || '@material-next/core/styles/colors';
  const targetPath = options.targetPath || '@material-next/core/colors';
